# -*- mode: ruby -*-
##
## FU Rakefile functionality for general build, setup and
## development tasks.
##
...
# TODO: needs to be updated for whatever approach we take at FU
...
namespace :app do
    ...
    task :start => 'setup:env' do
        ...
        env = ENV["FU_ENV"] || "production"
        system("FU_ENV=#{env} unicorn -Dc boot/unicorn.rb")
    end
